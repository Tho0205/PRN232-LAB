...
namespace PRN232.LAB.Repositories.Implementations
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<Entities.RefreshToken>? _refreshTokenRepository;
        ...
        public IGenericRepository<Entities.User> UserRepository
            => _userRepository ??= new GenericRepository<Entities.User>(_context);

        public IGenericRepository<Entities.RefreshToken> RefreshTokenRepository
            => _refreshTokenRepository ??= new GenericRepository<Entities.RefreshToken>(_context);
