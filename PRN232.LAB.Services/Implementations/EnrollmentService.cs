...
namespace PRN232.LAB.Services.Implementations
{
    public class EnrollmentService : IEnrollmentService
    {
        ...
        {
            var includeProps = "Student,Course,Course.Semester";
            ...
            {
                entity.Student.Enrollments = new List<Enrollment>();
            }

            if (entity.Course != null)
            {
                entity.Course.Enrollments = new List<Enrollment>();
                if (entity.Course.Semester != null)
                {
                    entity.Course.Semester.Courses = new List<Course>();
                }
            }
